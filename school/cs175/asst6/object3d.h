...
protected:
	...
	virtual void bezerp(Object3D * o1, Object3D * o2, Object3D * prev, Object3D * post, double t) {
		frame_ = o1->frame_.bezerp(o2->frame_, prev->frame_, post->frame_, t);
		beforeChildren_ = o1->beforeChildren_.bezerp(o2->beforeChildren_, prev->beforeChildren_, post->beforeChildren_, t);
		for (size_t i = 0; i < children_.size(); ++i)
		{
			children_[i]->bezerp(o1->children_[i], o2->children_[i], prev->children_[i], post->children_[i], t);
		}	
	}
...
public:
	...
	virtual Object3D * bezerp(Object3D * o2, Object3D * prev, Object3D * post, double t) {
		Object3D * bezerpation = this->clone();
		bezerpation->bezerp(this, o2, prev, post, t);
		return bezerpation;
	}
