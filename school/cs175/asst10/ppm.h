...
/* 
 * Write image data (in row-major order) to file. 
 * Does not deallocate buffer. 
 */
void ppmwrite(const char *filename, const packed_pixel_t buffer[], const int wp, const int hp);
