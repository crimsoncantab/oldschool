...
int CalcDist(short *pCurrFiltImgs_A16s , short *pCurrFiltImgs_B16s,
...
void CalcSqrDifferenceAndTakeBest( short *pCurrFiltImgs_A16s, short *pCurrFiltImgs_B16s,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) 
{
      ...
      short          *pCurrFiltImgs_A16s, *pCurrFiltImgs_B16s;
      ...
      unsigned int nHorizNeighbourMapping32u_2, nVerticalNeighbourMapping32u_2 , CordConv;
      int kOfKNN;
      int loc,ind;
      ...
      pCurrFiltImgs_A16s       = (short*)mxGetPr(prhs[2]);
      pCurrFiltImgs_B16s       = (short*)mxGetPr(prhs[3]);
      ...
      if (*pDownwardFlag) 
      {
            ...
            for (j=nFirstColForward; j<nLastColForward; j++) 
			{
                  ...
                  for (i=nFirstRowForward; i<nLastRowForward; i++) 
				  {
                        ...
                        nHorizNeighbourMapping32u    = pBestMapping32u[CONV_TO_LINEAR_MAPPING(nCurIterOffset - nLeftRightOffset,kOfKNN)];
                        nVerticalNeighbourMapping32u = pBestMapping32u[CONV_TO_LINEAR_MAPPING(nCurIterOffset - nTopBotOffset,kOfKNN)];
                        ...
                        CalcSqrDifferenceAndTakeBest(pCurrFiltImgs_A16s, pCurrFiltImgs_B16s, pBestErrorsImg32u, pBestMapping32u,
													 nCurrCandMapping32u, nCurIterOffset, nKernels, kOfKNN);
                        ...
                        for  (ind = 0; ind < kOfKNN; ind++) 
                        {
                              ...
                              CalcSqrDifferenceAndTakeBest(pCurrFiltImgs_A16s, pCurrFiltImgs_B16s, pBestErrorsImg32u, pBestMapping32u,
														   nCurrTypeMapping32u, nCurIterOffset,nKernels, kOfKNN);
