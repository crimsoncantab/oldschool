...
static inline void safe_glUseProgram(const GLuint program)
{
	if (GLEW_VERSION_2_0) glUseProgram(program); else glUseProgramObjectARB(program);
}

static inline void safe_glActiveTexture(const GLint n)
{
	if (GLEW_VERSION_2_0) glActiveTexture(n); else glActiveTextureARB(n);
}

static inline GLint safe_glGetUniformLocation(const GLuint program, const char varname[])
{
	GLint r;
...
static inline GLint safe_glGetAttribLocation(const GLuint program, const char varname[])
{
	GLint r;
...
static inline void safe_glUniformMatrix4fv(const GLint varhandle, const GLfloat data[])
{
...
static inline void safe_glUniform1i(const GLint varhandle, const GLint a)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform1i(varhandle, a); else glUniform1iARB(varhandle, a);
}
static inline void safe_glUniform2i(const GLint varhandle, const GLint a, const GLint b)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform2i(varhandle, a, b); else glUniform2iARB(varhandle, a, b);
}
static inline void safe_glUniform3i(const GLint varhandle, const GLint a, const GLint b, const GLint c)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform3i(varhandle, a, b, c); else glUniform3iARB(varhandle, a, b, c);
}
static inline void safe_glUniform4i(const GLint varhandle, const GLint a, const GLint b, const GLint c, const GLint d)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform4i(varhandle, a, b, c, d); else glUniform4iARB(varhandle, a, b, c, d);
}
static inline void safe_glUniform1f(const GLint varhandle, const GLfloat a)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform1f(varhandle, a); else glUniform1fARB(varhandle, a);
}
static inline void safe_glUniform2f(const GLint varhandle, const GLfloat a, const GLfloat b)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform2f(varhandle, a, b); else glUniform2fARB(varhandle, a, b);
}
static inline void safe_glUniform3f(const GLint varhandle, const GLfloat a, const GLfloat b, const GLfloat c)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform3f(varhandle, a, b, c); else glUniform3fARB(varhandle, a, b, c);
}
static inline void safe_glUniform3f(const GLint varhandle, const GLfloat a, const GLfloat b, const GLfloat c, const GLfloat d)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glUniform4f(varhandle, a, b, c, d); else glUniform4fARB(varhandle, a, b, c, d);
}
static inline void safe_glVertexAttrib1f(const GLint varhandle, const GLfloat a)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glVertexAttrib1f(varhandle, a); else glVertexAttrib1fARB(varhandle, a);
}
static inline void safe_glVertexAttrib2f(const GLint varhandle, const GLfloat a, const GLfloat b)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glVertexAttrib2f(varhandle, a, b); else glVertexAttrib2fARB(varhandle, a, b);
}
static inline void safe_glVertexAttrib3f(const GLint varhandle, const GLfloat a, const GLfloat b, const GLfloat c)
{
	if (varhandle < 0) return;
	if (GLEW_VERSION_2_0) glVertexAttrib3f(varhandle, a, b, c); else glVertexAttrib3fARB(varhandle, a, b, c);
}
static inline void safe_glVertexAttrib4f(const GLint varhandle, const GLfloat a, const GLfloat b, const GLfloat c, const GLfloat d)
{
	if (varhandle < 0) return;
...
static inline int getFileLength(FILE * const fp)
{
	int r(0);
	std::rewind(fp);
...
static inline int GetShaderSize(const char *filename)
{
	int count = -1;
...
static inline void LoadShader(const char *filename, int shader_size, GLchar *shader)
{
	FILE * const fd = std::fopen(filename, "r");
...
static inline void printInfoLog(GLuint obj, const char * filename)
{
...
static inline void LoadShaderFromFile(const char *filename, GLchar **shader)
{
...
static inline bool ShaderInit(const char *vertexfile, const char *fragfile, GLuint * const h_program)
{
