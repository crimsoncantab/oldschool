...
;; Partner:        Alex Yang <alexyang@fas.harvard.edu>
;; Collaborators: None
;; 
...
;
; The entire problem set took about 14 hours to complete.
; I spent 13 on it, and my partner spent 14.  I am very
; confident with my code, as I have tested it with many
; cases and think it would hold up in any case.
